...
class BatikListScreen extends StatelessWidget {
  final String cityName;
  const BatikListScreen({required this.cityName, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.brown,
        title: Text('Batik from $cityName'),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: controller.streamBatikByCity(cityName),
